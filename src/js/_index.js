...
const btnClosePopupAddCard = root.querySelector('.popup_add-card').querySelector('.popup__btn-close');
...
const formValidatorAddCard = root.querySelector('.popup_add-card').querySelector('.popup__form');
...
//new
// function addCardSubmitHandle({name, link}) {
//   const newCard = new Card({name, link}, cardSelector, popupWithImage.open.bind(popupWithImage));
